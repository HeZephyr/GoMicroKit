...
const (
	...
	HelloWorld_SayHelloStream_FullMethodName = "/helloworld.HelloWorld/SayHelloStream"
)
...
func (c *helloWorldClient) SayHelloStream(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[HelloResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type HelloWorld_SayHelloStreamClient = grpc.ServerStreamingClient[HelloResponse]
...
func (UnimplementedHelloWorldServer) SayHelloStream(*HelloRequest, grpc.ServerStreamingServer[HelloResponse]) error {
...
func _HelloWorld_SayHelloStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(HelloWorldServer).SayHelloStream(m, &grpc.GenericServerStream[HelloRequest, HelloResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type HelloWorld_SayHelloStreamServer = grpc.ServerStreamingServer[HelloResponse]
...
var HelloWorld_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "examples/helloworld/grpc/proto/helloworld.proto",
}
